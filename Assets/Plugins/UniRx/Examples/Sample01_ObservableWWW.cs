...
namespace UniRx.Examples {
    ...
    public class Sample01_ObservableWWW : MonoBehaviour {
        ...
        public System.IDisposable LinearDownload() {
            ...
            return query.Subscribe(x => Debug.Log("Google:" + x.google.Substring(0, 100) + "  Bing:" + x.bing.Substring(0, 100)));
