...
namespace LevelSystem {
    ...
    public class Level {
        ...
        public LevelType levelType = LevelType.hitBased; //  Level type for game state controller.
        ...
        // Time Limits
        public float maximumTimeLimit = 0; //  Maximum time limit to destroy all the targets.
        public float threeStarTimeLimit = 0; //  Time limit for succes rate of the user.
        public float twoStarTimeLimit = 0; //  Time limit for succes rate of the user.
